...
ifdef TARGET_2ND_ARCH
    ...
    LOCAL_SRC_FILES += $(LOCAL_PATH)/seccomp_policy/mediacodec-seccomp-$(TARGET_2ND_ARCH)-du.policy
else
    LOCAL_SRC_FILES := $(LOCAL_PATH)/seccomp_policy/mediacodec-seccomp-$(TARGET_ARCH).policy
    LOCAL_SRC_FILES += $(LOCAL_PATH)/seccomp_policy/mediacodec-seccomp-$(TARGET_ARCH)-du.policy
endif
